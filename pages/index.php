        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
               ...
               <!-- <ul class="nav navbar-nav navbar-left navbar-top-links">
                ...
                <ul class="nav navbar-right navbar-top-links navbar-default">
                    <li class="dropdown navbar-inverse">
                        <a class="dropdown-toggle " data-toggle="dropdown" href="#" style="background-color: #eff0f2;">
                            <i class="fa fa-bell fa" ></i> <b class="caret"></b>
                        </a>
                    ...
                    <li class="dropdown">
                        <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                            <i class="fa fa-user fa-fw" style="color:;"></i> Admin <b class="caret"></b>
                        </a>
               ...
               <br> <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                             ...
                             <li>
                                ...
                                <ul class="nav nav-second-level">
                                    <li>
                                        <a href="forms.php"><i class="fa fa-edit fa-fw"></i> Form1</a>
                                    </li>
                                    <li>
                                        <a href="forms.php"><i class="fa fa-edit fa-fw"></i> Form2</a>
                                    </li>
                                    <li>
                                <a href="forms.php"><i class="fa fa-edit fa-fw"></i> Form3</a>
                            </li>
                                </ul>
                                <!-- /.nav-second-level -->
                            </li>
                            ...
                            <li>
                                <a href="#"><i class=" glyphicon glyphicon-file "> </i>&nbsp&nbspReports<span class="fa arrow"></span></a>
                                <ul class="nav nav-second-level">
                                    <li>
                             ...
                             <li>
                                <a href="#"><i class=" glyphicon glyphicon-list "> </i>&nbsp&nbspItems<span class="fa arrow"></span></a>
                                <ul class="nav nav-second-level">
                                    <li>
                                        <a onclick="productsDetails();">products</a>
                                    </li>
                                    <li>
                                        <a onclick="inwardStock();">Inward Stock</a>
                                    </li>
                                    <li>
                                        <a onclick="outwardStock();">outward Stock</a>
                                    </li>
                                    <li>
                                        <a href="#">Third Level <span class="fa arrow"></span></a>
                                        <ul class="nav nav-third-level">
